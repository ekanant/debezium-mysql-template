#Reference from https://github.com/debezium/docker-images/blob/master/examples/mysql/1.6/inventory.sql

# Create the database that we'll use to populate data and watch the effect in the binlog
CREATE DATABASE inventory;
GRANT SELECT, RELOAD, SHOW DATABASES, REPLICATION SLAVE, REPLICATION CLIENT ON *.* TO 'myuser_001'@'%';
GRANT ALL PRIVILEGES ON inventory.* TO 'myuser_001'@'%';
